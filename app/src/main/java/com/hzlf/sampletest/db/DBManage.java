...
public class DBManage {
    ...
    public void addInfo(String no, Info_add1 info_add1, Info_add2 info_add2,
        ...
        db.execSQL(
                ...
                new Object[]{no, info_add1.getValue1(),
                        ...
                        info_add1.getValue10(), info_add1.getValue11(),
                        ...
                        info_add2.getValue19(), info_add2.getValue20(),
                        info_add2.getValue21(),
                        ...
                        info_add3.getValue20(), info_add3.getValue21(),
                        info_add3.getValue22(), info_add3.getValue23(),
                        info_add3.getValue24(), info_add3.getValue25(),
                        info_add3.getValue26(), info_add3.getValue27(),
                        info_add3.getValue28(), info_add3.getValue29(),
                        info_add3.getValue30()});
    }
    ...
    // 插入任务来源
    public void addTaskSource(Source source) {
        db = dbHelper.getWritableDatabase();
        db.execSQL("insert into TaskSource (name,addr) values (?,?)",
    ...
    public void updateinfo(Info_add info_add) {
        ...
        db.execSQL(
                ...
                new Object[]{info_add.getInfo_add1().getValue2(),
                        ...
                        info_add.getInfo_add1().getValue10(),
                        info_add.getInfo_add1().getValue11(),
                        ...
                        info_add.getInfo_add2().getValue19(),
                        info_add.getInfo_add2().getValue20(),
                        info_add.getInfo_add2().getValue21(),
                        ...
                        info_add.getInfo_add3().getValue16(),
                        ...
                        info_add.getInfo_add3().getValue30(),
        ...
        if (cursor.moveToNext()) {
            return new Info_add(
                    ...
                    new Info_add1(
                            ...
                            cursor.getString(cursor
                                    .getColumnIndex("weituodanweidizhi")),
                            cursor.getString(cursor
                                    .getColumnIndex("renwuleibie")),
                            cursor.getString(cursor
                                    .getColumnIndex("renwushuxing")),
                            cursor.getString(cursor
    ...
    public Source findTaskSource(String name) {
        ...
        if (cursor.moveToNext()) {
            return new Source(cursor.getString(cursor.getColumnIndex("name")),
    ...
    public Cursor findTaskSource() {
        db = dbHelper.getWritableDatabase();
        Cursor cursor = db.rawQuery("select name,addr from TaskSource ", null);
        return cursor;
    }

    public List<Source> findList_TaskSource() {
        ArrayList<Source> Sources = new ArrayList<Source>();
        Cursor cursor = findTaskSource();
        while (cursor.moveToNext()) {
            Sources.add(new Source(cursor.getString(cursor.getColumnIndex("name")),
                    cursor.getString(cursor.getColumnIndex("addr"))));
        }
        cursor.close();
        return Sources;
